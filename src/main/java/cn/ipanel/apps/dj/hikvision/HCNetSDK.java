...
public static class NET_DVR_SETUPALARM_PARAM extends Structure
{
    ...
    @Override
    public String toString() {
        return "NET_DVR_SETUPALARM_PARAM{" +
                "dwSize=" + dwSize +
                ", byLevel=" + byLevel +
                ", byAlarmInfoType=" + byAlarmInfoType +
                ", byRetAlarmTypeV40=" + byRetAlarmTypeV40 +
                ", byRetDevInfoVersion=" + byRetDevInfoVersion +
                ", byRetVQDAlarmType=" + byRetVQDAlarmType +
                ", byFaceAlarmDetection=" + byFaceAlarmDetection +
                ", bySupport=" + bySupport +
...
public static class NET_DVR_GPS_DATA extends Structure {
 ...
 public static interface fGPSDataCallback extends StdCallLibrary.StdCallCallback {
